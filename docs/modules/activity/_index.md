...
| 活动详情 + 报名 | spec-activity-detail.md | design-activity-detail.md | 已实现 | activity-list |
| 活动 CRUD（管理端） | spec-activity-crud.md | design-activity-crud.md | 已实现 | event |
| 5种活动模板 | spec-activity-templates.md | design-activity-templates.md | 已实现 | activity-crud |
